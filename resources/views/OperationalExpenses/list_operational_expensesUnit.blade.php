    ...
    <table class="table" style="width: 100%; border: 1px solid #000; margin: 0 0 1em 1em">
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($p<=$contador) @if($head=='GASTOS DE ADMINISTRACION' || $head=='GASTOS DE VENTAS' || $head=='DEPRECIACIONES Y AMORTIZACIONES' || $head=='TOTAL GASTOS OPERACIONALES' || $head=='UTILIDAD OPERACIONAL' ) @if(is_string($info[$p])==true) <td>{{$info[$p]}}</td>
                    @endif
